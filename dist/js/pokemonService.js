...
var pichu = new pokemon('pichu', 100, 'pikachu', 'raichu');

var igglybuff = new pokemon('igglybuff', 25, 'jigglypuff', 'wigglytuff');

var cleffa = new pokemon('cleffa', 25, 'clefairy', 'clefable');

var togepi = new pokemon('togepi', 50, 'togetic');
var togetic = new pokemon('togetic', 'togepi');

var tyrogue = new pokemon('tyrogue', 25, 'hitmonlee\/hitmonchan');

var smoochum = new pokemon('smoochum', 25, 'jynx');

var elekid = new pokemon('elekid', 25, 'electabuzz');

var magby = new pokemon('magby', 25, 'magmar');
