$(document).ready(function() {
  ...
  var pokemonArray =  pokemonService.getPokemon();
    ...
    // Reset field
    $('#resetselectPokemon').on('click', function(e) {
        e.preventDefault();
        resetForm();
    });
    // Reset  table
    ...
    //Pokémon Selector
    $('#selectPokemon').on('autocompleteselect', function(e, ui) {
        ...
        if (ui.item.evolve != true) {
            ...
            $('.buttons').append('<a id="resetselectPokemon" href="javascript:void(0)" onclick="resetForm();">Reset Selection</a>')
            return false;
        ...
        //Add multiple Pokémon of one species
            ...
            $('.buttons').append('<a id="resetselectPokemon" href="javascript:void(0)" onclick="resetForm();">Reset Selection</a><a id="addPokemonSpecies" href="javascript:void(0)" onclick="addPokemonSpecies();">Add Pokémon to Table</a>');
        }
